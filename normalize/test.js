...
test("proj-normalize: esriwkt", ({ eq }) => {
  ...
  const expected = `PROJCS["wgs_84_utm_zone_17n",GEOGCS["gcs_wgs_84",DATUM["wgs_84",SPHEROID["wgs_84",6378137,298.257223563]],PRIMEM["greenwich",0],UNIT["degree",0.017453292519943]],PROJECTION["transverse_mercator"],PARAMETER["central_meridian",-81],PARAMETER["false_easting",500000],PARAMETER["false_northing",0],PARAMETER["latitude_of_origin",0],PARAMETER["scale_factor",0.9996],UNIT["meter",1]]`;
...
test("proj-normalize: esriwkt 4326", ({ eq }) => {
  ...
  const expected = `GEOGCS["gcs_wgs_84",DATUM["wgs_84",SPHEROID["wgs_84",6378137,298.257223563]],PRIMEM["greenwich",0],UNIT["degree",0.017453292519943]]`;
  eq(esriwkt(txt), expected);
});
